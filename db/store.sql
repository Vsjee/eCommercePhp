...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2023 at 02:12 AM
...
INSERT INTO `products` (`P_ID`, `P_NAME`, `P_PRICE`, `P_DISCOUNT`, `P_AVAILABILITY`, `P_URL`, `P_DESCRIPTION`) VALUES
(1, 'terreneitor', 3333330, 0, 1, 'https://images3.memedroid.com/images/UPLOADED625/63c5fbc67a7d9.webp', 'terreneitor la maquina mas veloz de toda italia'),
(2, 'iPhone 13', 5680000, 0, 1, 'https://cdn.shopify.com/s/files/1/0604/8373/1606/products/IMG-6206240_600x.jpg?v=1661520210', 'Compatibilidad de red: 2G/3G/4G/5G\r\nTipo y Versión de SW: iOS 16\r\nCapacidad memoria RAM: 4 GB\r\nCapacidad de memoria interna en GigaBytes (GB): 128, 256 y 512 GB'),
(3, 'AMD RYZEN 7 3700X', 1699000, 0, 1, 'https://www.pcware.com.co/wp-content/uploads/2020/10/ryzen1.webp', 'Creados para servir mayor poder a usuarios exigentes. Asegura tu triunfo con procesadores de alto desempeño. Mayor eficiencia con un performance de  memoria optimizado.'),
(4, 'IdeaPad 5 Gen 7 (14\" AMD)', 2850000, 0, 1, 'https://www.notebookcheck.com/fileadmin/Notebooks/News/_nc3/lenovo_laptop_ideapad_5_pro_gen_7_gallery_8_9.jpg', 'Laptop elegante de 14\" con procesadores móviles AMD Ryzen™\r\nTarjeta gráfica AMD Radeon™ integrada para un alto rendimiento sin problemas\r\nChasis delgado totalmente metálico (opcional) para ofrecer portabilidad y durabilidad'),
(5, 'Samsung s23', 4500000, 0, 1, 'https://images.samsung.com/co/smartphones/galaxy-s23/buy/kv_group_PC_v2.jpg', 'Consigue todos los detalles\r\nCapture más detalles con una cámara gran angular de 50MP.3 La tecnología Detail Enhancer utiliza IA para mejorar la profundidad y definición para obtener fotos de una calidad sorprendentemente alta.'),
(6, 'Airpods (3.ª generación)', 999999, 0, 1, 'https://cdn.shopify.com/s/files/1/0604/8373/1606/products/Airpods_PDP_Image_Position-1__ESES_600x.jpg?v=1662986473', '\r\nLos AirPods (tercera generación) cuentan con audio espacial personalizado para que disfrutes un sonido envolvente, mayor duración de la batería y resistencia al agua y al sudor. Prepárate para una experiencia llena de magia.'),
(7, 'Amazon Echo Dot 3', 200000, 0, 1, 'https://falabella.scene7.com/is/image/FalabellaCO/3808526_1?wid=1500&hei=1500&qlt=70', 'Tamaño empaque: 12 x 10 x 11.5 cm\r\nTamaño producto: 4.3 x 9.9 x 9.9 cm\r\nSonido 360\r\n4 Micrófonos incorporados con reconocimiento de voz de campo lejano, que permite usarlo en el modo manos libres'),
(8, 'megafono', 250000, 0, 1, 'https://images.unsplash.com/photo-1517816428104-797678c7cf0c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80', 'aparato con forma de cono utilizado para amplificar sonidos.'),
(9, 'Gafas 3d', 100000, 0, 1, 'https://http2.mlstatic.com/D_NQ_NP_966499-MCO31545311148_072019-O.webp', '-Visor de alta calidad, Alta definición Sensor de movimiento\r\n-Despierta tus sentidos siente el vació de una caída\r\n-Diseñado para personas que usan o no lentes\r\n-Lente graduable para mayor nitidez y cuidado de tus ojos'),
